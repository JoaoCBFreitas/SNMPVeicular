These files will contain the FMI(Failure Mode Identifier) and SPN(Suspect Parameter Number) codes and descriptions that are included in the J1939 standard. 
